...
-- Portable Mailbox: an unused, instant self-target dummy spell provides a
-- clean client item-use lifecycle and a cooldown key distinct from the repair
-- hammer. The Classic spell script deploys the mailbox beside the player.
...
WHERE `Id` IN (22700, 4071, 4072, 4073, 4074, 23076) AND `ScriptName` = 'spell_mantech_portable_mailbox';

INSERT INTO `spell_scripts` (`Id`, `ScriptName`)
VALUES (6562, 'spell_mantech_portable_mailbox')
